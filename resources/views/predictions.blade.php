    ...
    <div class="space-y-6">
        ...
        <div class="space-y-3">
            ...
            <div class="grid gap-4">
                ...
                <div class="live-card bg-white rounded-lg shadow-lg p-5 border-l-4 border-red-500 relative overflow-hidden">
                    <div class="relative z-10">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <div class="flex items-center gap-2">
                                <span class="live-indicator px-3 py-1 bg-red-600 text-white text-sm font-bold rounded-full flex items-center gap-1">
        ...
        <div class="space-y-3">
            ...
            <div class="grid gap-4">
                ...
                <div class="bg-white rounded-lg shadow p-5 border-l-4 {{ $prediction->points_earned > 0 ? 'border-green-500' : 'border-gray-300' }}">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <span class="text-xs text-gray-500">{{ $prediction->match->match_date->translatedFormat('l d F Y - H:i') }}</span>
                            <div class="text-sm text-gray-400">{{ $prediction->match->stadium }}</div>
